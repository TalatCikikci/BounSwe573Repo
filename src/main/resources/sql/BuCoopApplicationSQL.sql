...
CREATE VIEW productall AS (SELECT a.id, a.productname, a.productdesc, a.active as productactive, b.categoryid, b.categoryname, c.producerid, c.producername, c.producerdesc, c.active as produceractive FROM product a INNER JOIN category b ON a.category=b.id INNER JOIN producer c ON a.producer=c.id);
